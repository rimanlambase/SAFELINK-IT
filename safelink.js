...
.breadcrumb{margin:20px 0 5px;}
  ...
  <b:if cond='data:blog.url == &quot;https://safelink-it.blogspot.com/p/generate.html&quot;'>
<style type='text/css'>
...
var str = currentURL;
  var res = str.replace("https://safelink-it.blogspot.com/p/generate.html?url=", "");
$(".Visit_Link").hide();
function changeLink(){
...
<header itemscope='itemscope' itemtype='https://schema.org/WPHeader'>
      <b:section class='header' id='header' maxwidgets='1' showaddelement='no'>
        <b:widget id='Header1' locked='true' title='Safelink Converter (Header)' type='Header' version='1'>
...
//<![CDATA[
  ...
  input.onkeyup = function() {
    if (input.value != "") {
      output.value = "https://safelink-it.blogspot.com/p/generate.html?url=" + Base64.encode(this.value); //change with your link
    } else {
      output.value = "";
    }
  }
